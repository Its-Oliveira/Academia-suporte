...
const ModuleDetail = () => {
  ...
  return <div className="space-y-6">
      <Button variant="ghost" onClick={() => navigate('/training')} className="gap-2">
      ...
      {module.days && module.days.length > 0 ? <DayNavigation days={module.days} currentDayIndex={currentDayIndex} onDayChange={setCurrentDayIndex} /> : <Card>
          <CardHeader>
