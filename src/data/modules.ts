        ...
        pages: [
          {
            ...
            items: [
              {
                id: 'bdi-1',
                text: '<strong>1.1. BDI (Benefícios e Despesas Indiretas)</strong>',
                completed: false
              },
              {
                id: 'bdi-2',
              ...
              {
                id: 'encargos-1',
                text: '<strong>1.2. Encargos Trabalhistas</strong>',
                completed: false
              },
              {
                id: 'encargos-2',
          ...
          },
          {
            ...
            subtitle: 'Objetivo: Criar etapas, composições e gerenciar insumos no orçamento.',
            items: [
              {
                id: 'etapas-1',
                text: '<strong>2.1. Etapas e Composições</strong>',
                completed: false
              },
              {
                id: 'etapas-2',
              ...
              {
                id: 'insumos-1',
                text: '<strong>2.2. Menu Exibir – Lista de Insumos</strong>',
                completed: false
              },
              {
                id: 'insumos-2',
          ...
          {
            id: 'page-3',
            title: 'MÓDULO 2 – LISTA DE COMPOSIÇÕES E CRONOGRAMA',
            subtitle: 'Objetivo: Editar composições e criar cronograma do orçamento.',
            items: [
              {
                id: 'composicoes-1',
                text: '<strong>2.3. Menu Exibir – Lista de Composições</strong>',
                completed: false
              },
              {
                id: 'composicoes-2',
              ...
              {
                id: 'cronograma-1',
                text: '<strong>2.4. Menu Exibir – Cronograma</strong>',
                completed: false
              },
              {
                id: 'cronograma-2',
          ...
          {
            id: 'page-4',
            title: 'MÓDULO 2 – MENU EDITAR',
            subtitle: 'Objetivo: Configurar opções avançadas do orçamento.',
            items: [
              {
                id: 'editar-1',
                text: '<strong>2.5. Menu Editar</strong>',
                completed: false
              },
              {
                id: 'editar-2',
                text: '<strong>Sub-menu: Orçamento</strong><br/>Configurações:<br/>• Método: Arredondar em 2 casas decimais<br/>• Ative a opção "Máscara de Item"<br/>• Clique em "Salvar"',
                completed: false
              },
              {
                id: 'editar-3',
                text: '<strong>Sub-menu: Permissões</strong><br/>1. Selecione os usuários desejados<br/>2. Atribua as seguintes permissões:<br/>• Pode Emitir Relatórios<br/>• Pode Editar o Orçamento<br/>• Pode Excluir o Orçamento',
                completed: false
              },
              {
                id: 'editar-4',
                text: '<strong>Sub-menu: Bancos</strong><br/>Configurações:<br/>1. Ative a base CPOS<br/>2. Escolha a data-base mais recente<br/>3. Configure arredondamento: 2 casas decimais<br/>4. Ative a opção: "Atualizar Estrutura da Composição"',
                completed: false
              }
            ]
          },
          {
            id: 'page-5',
            title: 'MÓDULO 2 – FERRAMENTAS',
            subtitle: 'Objetivo: Utilizar ferramentas avançadas do orçamento.',
            items: [
              {
                id: 'ferramentas-1',
                text: '<strong>Sub-menu: Ferramentas</strong>',
                completed: false
              },
              {
                id: 'ferramentas-2',
              ...
              {
                id: 'ferramentas-4',
                text: '<strong>Sub-menu: Ajuste RDC</strong><br/>Aplique um desconto de 22%',
                completed: false
              },
              {
                id: 'ferramentas-5',
                text: '<strong>Sub-menu: Gerador de Propostas para Pregão</strong><br/>1. Lance 50% do valor do orçamento no campo "menor lance"<br/>2. Gere 18 propostas<br/>3. Selecione a opção "desconto RDC"',
                completed: false
              }
            ]
          },
          {
            id: 'page-6',
            title: 'MÓDULO 2 – RELATÓRIOS',
            subtitle: 'Objetivo: Personalizar e gerar relatórios do orçamento.',
            items: [
              {
                id: 'relatorios-1',
                text: '<strong>Sub-menu: Relatórios</strong>',
                completed: false
              },
              {
                id: 'relatorios-2',
